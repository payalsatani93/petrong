  ...
  return (
    <section className="py-5 bg-white relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center text-center py-12 px-6 md:px-20 bg-white mt-16 space-y-6">
        <h2 className="text-[24px] sm:text-3xl md:text-4xl font-medium text-black" style={{ fontFamily: "var(--font-Poppins)" }}>
          Let's build great things together!
        </h2>

        <p className="text-gray-600 text-[14px] sm:text-lg  leading-relaxed max-w-2xl" style={{ fontFamily: "var(--font-Montserrat)" }}>
        ...
        <button className="px-8 py-3 bg-black text-white rounded-md border border-transparent hover:bg-gray-700 hover:text-white transition-colors duration-300">
          Contact
        </button>
      </div>
    </section>
