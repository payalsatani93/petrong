        ...
        <div className="max-w-7xl w-full mx-auto flex flex-col gap-10">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-2/3 w-full">
              ...
              <p className="mb-4">
                2021 is slowly reaching its end. This year’s UI design trends
                and UX trends will gently move aside to let next year’s winners
                take their place.
              </p>
              <p className="mb-4">
                ...
                consumers will judge your company based not only on the quality
                of your product but also on the quality of your design. Poorly
              ...
              <p>
                ...
                interface designs of the past, but if you don’t update it,
                you’ll most likely end up with an old website.
              </p>
            </div>
