    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-2 px-6 md:px-16">
        ...
        <div className="md:w-1/2 w-full flex justify-center md:justify-start">
          <div className="bg-white p-3 md:p-10 w-full text-center xl:text-start ">      {/* Section-1 */}
      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-8 px-6 md:px-16 gap-8">
        ...
        <div className="md:w-1/2 w-full flex flex-col justify-center items-center md:items-start">
          <div className="bg-white md:w-4/5 text-center md:text-left">
            ...
            <ul className="mt-4 space-y-2 w-full">
              {[
                ...
                <li
                  key={index}
                  className="w-full flex md:flex-row flex-row items-center md:justify-start justify-center gap-2"
                >
                  <span className="w-3 h-3 bg-green-500 rounded-full flex-shrink-0"></span>
        ...
        <div className="md:w-1/2 w-full flex justify-center items-center">
          <img
            ...
            className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl aspect-square object-cover rounded-2xl shadow-lg"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-8 px-6 md:px-16 gap-8">
        ...
        <div className="md:w-1/2 w-full flex justify-center md:justify-start">
          <div className="bg-white p-4 md:p-8 w-full text-center xl:text-start md:w-4/5">
      ...
      <div className="flex flex-col items-center justify-center text-center py-8 px-6 bg-white gap-4">
        ...
        <button className="mt-4 px-8 py-3 bg-black text-white rounded-md hover:bg-green-600 transition shadow-md">
